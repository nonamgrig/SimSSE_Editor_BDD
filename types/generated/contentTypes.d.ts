...
export interface ApiBioeventBioevent extends Struct.CollectionTypeSchema {
  collectionName: 'bioevents';
  info: {
    description: '';
    displayName: 'bioevent';
    pluralName: 'bioevents';
    singularName: 'bioevent';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    comparaison: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    variablephysio: Schema.Attribute.Relation<
      'oneToOne',
      'api::variablephysio.variablephysio'
    >;
  };
}
...
export interface ApiEventTrendLienEventTrendLien
  extends Struct.CollectionTypeSchema {
  collectionName: 'event_trend_liens';
  info: {
    displayName: 'event-trend-lien';
    pluralName: 'event-trend-liens';
    singularName: 'event-trend-lien';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::event-trend-lien.event-trend-lien'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    bioevent: Schema.Attribute.Relation<'oneToOne', 'api::bioevent.bioevent'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiGroupeGroupe extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    decede: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    EU: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    implique: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::groupe.groupe'
    > &
      Schema.Attribute.Private;
    psy: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    publishedAt: Schema.Attribute.DateTime;
    scenario: Schema.Attribute.Relation<'oneToOne', 'api::scenario.scenario'>;
    scene: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<1>;
    t0: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    UA: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    UR: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    x: Schema.Attribute.Decimal;
    y: Schema.Attribute.Decimal;
  };
}
...
export interface ApiImageImage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::image.image'> &
      Schema.Attribute.Private;
    modeles: Schema.Attribute.Relation<'manyToMany', 'api::modele.modele'>;
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiLienModeleLienModele extends Struct.CollectionTypeSchema {
  collectionName: 'lien_modeles';
  info: {
    description: '';
    displayName: 'instance-modele';
    pluralName: 'lien-modeles';
    singularName: 'lien-modele';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiModeleModele extends Struct.CollectionTypeSchema {
...
export interface ApiPlastronPlastron extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::plastron.plastron'
    > &
      Schema.Attribute.Private;
    modele: Schema.Attribute.Relation<'oneToOne', 'api::modele.modele'>;
    profil: Schema.Attribute.Relation<'oneToOne', 'api::profil.profil'>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiProfilProfil extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    variablephysio_profils: Schema.Attribute.Relation<
      'manyToMany',
      'api::variablephysio-profil.variablephysio-profil'
    >;
  };
}

export interface ApiScenarioImageLienScenarioImageLien
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::scenario-image-lien.scenario-image-lien'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiScenarioScenario extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    decede: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    description: Schema.Attribute.String;
    duree: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<100>;
    EU: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    implique: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
    ...
    > &
      Schema.Attribute.Private;
    pmax: Schema.Attribute.Decimal;
    pmay: Schema.Attribute.Decimal;
    prvx: Schema.Attribute.Decimal;
    prvy: Schema.Attribute.Decimal;
    psy: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    publishedAt: Schema.Attribute.DateTime;
    statut: Schema.Attribute.Boolean;
    tags: Schema.Attribute.Relation<'manyToMany', 'api::tag.tag'>;
...
export interface ApiTrendTrend extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    cible: Schema.Attribute.Decimal;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiVariablephysioProfilVariablephysioProfil
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    profils: Schema.Attribute.Relation<'manyToMany', 'api::profil.profil'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiVariablephysioVariablephysio
  extends Struct.CollectionTypeSchema {
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::bioevent.bioevent': ApiBioeventBioevent;
      'api::categorie.categorie': ApiCategorieCategorie;
      'api::event-trend-lien.event-trend-lien': ApiEventTrendLienEventTrendLien;
      'api::event.event': ApiEventEvent;
      'api::groupe.groupe': ApiGroupeGroupe;
      'api::image.image': ApiImageImage;
      'api::lien-modele.lien-modele': ApiLienModeleLienModele;
      'api::modele.modele': ApiModeleModele;
      'api::plastron.plastron': ApiPlastronPlastron;
      'api::profil.profil': ApiProfilProfil;
      'api::scenario-image-lien.scenario-image-lien': ApiScenarioImageLienScenarioImageLien;
      'api::scenario.scenario': ApiScenarioScenario;
      'api::tag.tag': ApiTagTag;
      'api::trend.trend': ApiTrendTrend;
      'api::variablephysio-profil.variablephysio-profil': ApiVariablephysioProfilVariablephysioProfil;
      'api::variablephysio.variablephysio': ApiVariablephysioVariablephysio;
